...
assim_path <- "/scratch/sadamov/wd/v1/mod_sdes_combined.txt"

# Cosmo-1e Baselines
cosmo_path <- "/scratch/sadamov/wd/osm/mod_sdes_combined.txt"
...
```{r data, echo = TRUE}
for (model_version in c("times10", "osm", "v1WrongGridBoxes")) {
  i <- 1
  date <- 20033100
  nc_path <- paste0("/scratch/sadamov/wd/", model_version, "/", date, "_c1e_tsa_alnus_", model_version, "/lm_coarse/lfff00150000") # This can be any netCDF file with POAC (e.g.)
  variable <- "ALNUfr"

...
```{r data, echo = TRUE}
nc_path <- paste0("/scratch/sadamov/wd/threshold100/20030100_c1e_tsa_alnus_threshold100/lm_coarse/lfff00150000") # This can be any netCDF file with POAC (e.g.)

system(paste0("fxfilter --force -s ALNUtthrs ", nc_path, " -o ", nc_path, "_filtered"))
system(paste0("fxconvert --force nc ", nc_path, "_filtered -o ", nc_path, "_filtered.nc"))

con <- nc_open(paste0(nc_path, "_filtered.nc"))
layer <- ncvar_get(con, "ALNUtthrs")

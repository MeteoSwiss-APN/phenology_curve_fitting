...
$$ (0.998 + 0.05 * (\frac{saisl}{42.860})^{0.7}) * $$
$$ \frac{1}{1 + \exp(-0.531 * \frac{42.860}{saisl} * (day - 12.585 * \frac{saisl}{42.860}))} * $$
$$ (0.998 + 0.05 * (\frac{saisl}{42.860})^{0.7}) * $$
$$ \frac{1}{1 + \exp(0.176 * (\frac{42.860}{saisl})^2 * (day - 31.326 * \frac{saisl}{42.860}))} $$
...
assim_path <- "/scratch/sadamov/wd/v2/mod_pollen_combined.txt"

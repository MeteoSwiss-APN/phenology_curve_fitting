...
Da wir im Emissionsteil arbeiten werden, genügt es die Gitterboxen am nächsten am Boden zu berücksichtigen (2D-Raster). Die kostspielige 3D Simulation passiert erst im nächsten Schritt, der in diesem Projekt nicht abgeändert wird. Dies ist 

# Nächste Schritte
 
- Implementierung der variablen Felder Tempsummen-Felder und erste COSMO Runs

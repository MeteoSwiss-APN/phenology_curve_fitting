...
- Wie viel zusätzliche Computing-Ressourcen werden benötigt?
...
Das Feld der Tuningfaktoren müsste extern bereitgestellt werden (analog zu den kritischen Temperatursummen oben). Dieses sollte dann auch für jeden Modelllauf neu berechnet werden (also alle 3h).

...
- Phänologie: Beginn (und Ende) der Pollensaison von den real-time Pollendaten triggern (oder verhindern) lassen (z.B. via variables Feld der kritischen Temperatursummen)
...
- lmorg -> organize_pollen -> pol_emissions::emiss_p -> emiss_formula_zink (für \\(f_{Q,seas}\\))
